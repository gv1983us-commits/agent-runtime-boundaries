...
An invariant does not prohibit all change. It defines the condition under which a change can still count as an acceptable continuation.
...
7. What state change was committed for the next step?
8. Which claims are verified, observed, self-reported or unknown?
