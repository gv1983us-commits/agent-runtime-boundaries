...
These responsibilities may be implemented by different components.
...
This distinction aligns with execution-evidence systems in which capability, authorization, invocation, evidence and validation are reported separately.
